...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accountEdit = (EditText) findViewById(R.id.signin_email);
        passwordEdit = (EditText) findViewById(R.id.signin_password);
        rememberPass = (CheckBox) findViewById(R.id.sign_in_remember_pass);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (account.equals("admin") && password.equals("123456")) {
                    ...
                    Toast.makeText(SignInActivity.this, "account or password is invalid",
